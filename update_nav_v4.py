...
nav_template = '''    <nav id="main-nav" class="fixed top-0 w-full z-50 transition-all duration-300 pointer-events-none bg-transparent">
        <div class="container mx-auto px-6 max-w-7xl h-[90px] flex justify-between items-center relative pointer-events-auto">
            ...
            <div class="hidden md:flex absolute left-1/2 -translate-x-1/2 items-center gap-12 font-medium text-[15px]">
                <a href="index.html" class="text-white/90 hover:text-white transition-colors duration-300">Home</a>
...
for file in html_files:
    ...
    if nav_pattern.search(content):
        ...
        if page_name == 'index.html':
            page_template = page_template.replace('href="index.html" class="text-white/90 hover:text-white', 'href="index.html" class="text-brand-primary hover:text-white')
        elif page_name == 'about.html':
            page_template = page_template.replace('href="about.html" class="text-white/90 hover:text-white', 'href="about.html" class="text-brand-primary hover:text-white')
        elif page_name == 'services.html':
            page_template = page_template.replace('href="services.html" class="text-white/90 hover:text-white', 'href="services.html" class="text-brand-primary hover:text-white')
        elif page_name == 'portfolio.html':
            page_template = page_template.replace('href="portfolio.html" class="text-white/90 hover:text-white', 'href="portfolio.html" class="text-brand-primary hover:text-white')
        elif page_name == 'contact.html':
            page_template = page_template.replace('href="contact.html" class="text-white/90 hover:text-white', 'href="contact.html" class="text-brand-primary hover:text-white')
